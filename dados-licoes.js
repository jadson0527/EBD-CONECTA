    ...
    adultos: {
        ...
        "3": {
            ...
            "10": {
                ...
                objetivos: [
                    "Expor a injustiça sofrida por Paulo e destacar sua fidelidade a Deus.",
                    "Mostrar como Paulo defendeu o Evangelho com verdade, coragem e equilíbrio.",
                    "Ensinar que a esperança em Cristo sustenta o cristão diante das pressões."
                ],

                pontoPrincipal:
                    "A fé firme e a esperança em Deus sustentam o cristão mesmo diante de injustiças, pressões e autoridades humanas.",

                introducao:
                    "Em Atos 24, encontramos Paulo diante do governador Félix, enfrentando acusações apresentadas por seus opositores. O apóstolo estava sendo julgado não por ter cometido um crime, mas por causa de sua fé e de sua pregação do Evangelho.\n\nMesmo diante de acusações injustas, Paulo permaneceu firme. Ele não abandonou sua fé, não distorceu a verdade e não permitiu que a pressão das autoridades mudasse sua posição.\n\nEsta passagem nos ensina que a verdadeira esperança não está nas circunstâncias, nas pessoas ou nas autoridades. Nossa esperança está em Deus, que continua soberano mesmo quando enfrentamos momentos difíceis.",

                desenvolvimento: [

                    {
                        titulo:
                            "I. A ACUSAÇÃO INJUSTA CONTRA PAULO",

                        introducao:
                            "Paulo foi levado diante do governador Félix e passou a enfrentar acusações feitas por líderes judeus. O objetivo dos acusadores era apresentar o apóstolo como uma ameaça à sociedade e à religião.",

                        topicos: [

                            {
                                titulo:
                                    "1. Uma acusação cuidadosamente planejada",

                                texto:
                                    "O sumo sacerdote Ananias, alguns anciãos e Tértulo compareceram diante de Félix para apresentar suas acusações contra Paulo.\n\nA situação demonstra que havia uma oposição organizada contra o apóstolo. Seus adversários não estavam simplesmente procurando esclarecer os fatos; desejavam encontrar uma maneira de condená-lo.\n\nPaulo estava sofrendo oposição justamente por continuar anunciando Cristo.",

                                aplicacao:
                                    "Nem toda acusação que recebemos corresponde à verdade. O cristão precisa manter sua integridade mesmo quando for injustamente acusado.",

                                destaque:
                                    "A oposição não significa que Deus abandonou seus servos."
                            },

                            {
                                titulo:
                                    "2. A bajulação de Tértulo",

                                texto:
                                    "Tértulo iniciou sua apresentação utilizando palavras elogiosas ao governador Félix. Seu discurso procurava conquistar a simpatia da autoridade antes de apresentar as acusações contra Paulo.\n\nDepois dos elogios, Paulo foi apresentado como uma pessoa perigosa e causadora de problemas.\n\nEsse episódio mostra como as palavras podem ser utilizadas para manipular uma situação. Por isso, o cristão deve ter discernimento e não se deixar conduzir simplesmente por discursos persuasivos.",

                                aplicacao:
                                    "Precisamos aprender a distinguir entre palavras sinceras e discursos utilizados para manipular pessoas.",

                                destaque:
                                    "O cristão deve cultivar uma comunicação marcada pela verdade."
                            },

                            {
                                titulo:
                                    "3. As falsas acusações",

                                texto:
                                    "Paulo foi acusado de provocar sedição, liderar uma seita e profanar o templo. Entretanto, os acusadores não apresentaram provas capazes de confirmar suas acusações.\n\nO apóstolo não havia abandonado sua fé nem se envolvido em uma revolta política. Ele estava sendo atacado principalmente por causa de sua mensagem sobre Cristo e a ressurreição.\n\nA experiência de Paulo mostra que uma pessoa pode ser injustamente julgada pelos homens sem ser considerada culpada diante de Deus.",

                                aplicacao:
                                    "Quando enfrentarmos injustiça, devemos evitar a vingança e continuar vivendo de maneira correta diante de Deus.",

                                destaque:
                                    "A injustiça humana não muda a verdade diante de Deus."
                            }
                    ...
                    {
                        titulo:
                            "II. A DEFESA DO EVANGELHO",

                        introducao:
                            "Diante das acusações, Paulo teve a oportunidade de apresentar sua defesa. Ele não utilizou agressividade nem abandonou suas convicções. Sua resposta foi marcada pela verdade, respeito e coragem.",

                        topicos: [

                            {
                                titulo:
                                    "1. Paulo responde com serenidade",

                                texto:
                                    "Paulo respeitou a autoridade de Félix, mas não abriu mão da verdade. Ele explicou que não havia provocado tumultos nem profanado o templo.\n\nSua defesa foi objetiva e baseada nos fatos. O apóstolo não precisou inventar uma história para tentar convencer o governador.\n\nSua vida e seu testemunho estavam de acordo com aquilo que ele pregava.",

                                aplicacao:
                                    "Quando precisarmos defender nossa fé ou responder a uma acusação, devemos falar a verdade com equilíbrio e respeito.",

                                destaque:
                                    "Uma vida íntegra fortalece nosso testemunho."
                            },

                            {
                                ...
                                texto:
                                    "Paulo deixou claro que sua esperança estava relacionada à ressurreição dos mortos. Essa esperança fazia parte do centro de sua fé.\n\nMesmo diante de uma autoridade poderosa, o apóstolo não escondeu suas convicções. Ele continuou confessando sua fé em Deus e na ressurreição.\n\nPara o cristão, a esperança da ressurreição muda a maneira de enfrentar as dificuldades presentes.",

                                aplicacao:
                                    "Nossa esperança em Cristo deve ser maior do que o medo das circunstâncias.",

                                destaque:
                                    "Quem espera em Cristo pode permanecer firme mesmo diante da oposição."
                            },

                            {
                                titulo:
                                    "3. Uma consciência sem ofensa",

                                texto:
                                    "Paulo declarou que procurava manter uma consciência sem ofensa diante de Deus e dos homens.\n\nIsso significa que sua preocupação não era apenas parecer inocente diante das autoridades. Ele desejava viver de maneira correta diante do próprio Deus.\n\nUma consciência limpa não significa uma vida sem erros. Significa viver com sinceridade diante de Deus, reconhecendo os erros e procurando permanecer fiel.",

                                aplicacao:
                                    "Devemos avaliar constantemente nossas atitudes e procurar viver de maneira coerente com aquilo que professamos.",

                                destaque:
                                    "Nossa maior defesa é uma vida coerente com a nossa fé."
                            }
                    ...
                    {
                        titulo:
                            "III. UMA ESPERANÇA QUE SUPERA A OPRESSÃO",

                        introducao:
                            "Paulo permaneceu preso durante um longo período, mas suas circunstâncias não conseguiram destruir sua esperança. Sua confiança estava em Deus e não nas decisões dos homens.",

                        topicos: [

                            {
                                titulo:
                                    "1. Félix ouve a mensagem",

                                texto:
                                    "Félix teve oportunidade de ouvir Paulo falar sobre a fé em Cristo Jesus. O governador conhecia algumas coisas relacionadas ao Caminho e decidiu ouvir o apóstolo.\n\nPaulo não aproveitou a oportunidade simplesmente para tentar conseguir sua liberdade. Ele anunciou uma mensagem que confrontava a vida de Félix.",

                                aplicacao:
                                    "Quando tivermos oportunidade de falar sobre Cristo, devemos apresentar a verdade com amor e coragem.",

                                destaque:
                                    "O Evangelho não deve ser adaptado apenas para agradar as pessoas."
                            },

                            {
                                titulo:
                                    "2. Justiça, domínio próprio e juízo",

                                texto:
                                    "Paulo falou a Félix sobre justiça, domínio próprio e juízo vindouro. A mensagem tocava diretamente em áreas importantes da vida humana.\n\nFélix ficou amedrontado, mas adiou sua decisão. Isso demonstra que ser emocionalmente tocado pela Palavra não é o mesmo que obedecer a Deus.\n\nA Palavra de Deus confronta o pecado e chama o ser humano ao arrependimento.",

                                aplicacao:
                                    "Não devemos adiar aquilo que Deus está mostrando através de sua Palavra.",

                                destaque:
                                    "Ser confrontado pela Palavra exige uma resposta."
                            },

                            {
                                titulo:
                                    "3. Paulo permanece firme",

                                texto:
                                    "Mesmo permanecendo preso por aproximadamente dois anos, Paulo não abandonou sua fé.\n\nSuas circunstâncias eram difíceis, mas sua esperança continuava firme. A prisão não conseguiu impedir o testemunho do apóstolo.\n\nPaulo nos ensina que a verdadeira liberdade não depende apenas das circunstâncias externas. Uma pessoa pode estar enfrentando dificuldades e ainda assim possuir esperança, paz e confiança em Deus.",

                                aplicacao:
                                    "Quando a resposta de Deus parecer demorar, continue obedecendo e confiando no Senhor.",

                                destaque:
                                    "A esperança em Cristo permanece firme mesmo quando as circunstâncias mudam."
                            }
                ...
                conclusao:
                    "A experiência de Paulo diante de Félix nos ensina que a fidelidade cristã precisa ser maior do que o medo da oposição.\n\nPaulo foi acusado injustamente, permaneceu preso e enfrentou autoridades poderosas. Mesmo assim, não abandonou sua fé nem negociou a verdade.\n\nSua esperança estava em Deus. Por isso, suas circunstâncias não determinaram sua fidelidade.\n\nQue também possamos viver com uma consciência limpa, defender nossa fé com coragem e permanecer firmes na esperança que temos em Cristo.",
                ...
                perguntas: [

                    {
                        nivel: "🟢 Fácil",
                        pergunta:
                            "Diante de qual governador Paulo foi julgado em Atos 24?",
                        resposta:
...

                    {
                        nivel: "🟡 Média",
                        pergunta:
                            "Quem apresentou as acusações contra Paulo?",
                        resposta:
                            "Tértulo, acompanhado do sumo sacerdote Ananias e de alguns anciãos."
                    },

                    {
                        nivel: "🟠 Difícil",
                        pergunta:
                            "Qual era uma das principais convicções apresentadas por Paulo em sua defesa?",
                        resposta:
                            "A esperança na ressurreição dos mortos."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "O que Paulo procurava manter diante de Deus e dos homens?",
                        resposta:
                            "Uma consciência sem ofensa, vivendo de maneira íntegra diante de Deus e das pessoas."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "O que podemos aprender com Paulo sobre permanecer firme em tempos difíceis?",
                        resposta:
    ...
    jovens: {
        ...
        "3": {
            ...
            "10": {
                ...
                pontoPrincipal:
                    "Mesmo após suas derrotas, Sansão reconheceu que precisava novamente da força de Deus.",
                ...
                introducao:
                    "Nesta lição, exploraremos a etapa final da trajetória conturbada de Sansão, refletindo sobre suas vitórias e derrotas, tanto nos confrontos com os inimigos de Israel, quanto na batalha contra suas próprias fraquezas.\n\nSua vida nos alerta para os perigos dos relacionamentos destrutivos, das escolhas impulsivas e da sedução do pecado.\n\nSansão foi um libertador extraordinariamente forte, capaz de derrubar seus adversários com facilidade, mas permanecia cativo da concupiscência.\n\nAinda assim, veremos como, apesar de tudo, Deus preserva sua soberania e graça, manifestando-se poderosamente até o fim da vida deste juiz.",
                ...
                desenvolvimento: [

                    {
                        ...
                        introducao:
                            "Nesta etapa da vida de Sansão, vemos grandes demonstrações de força, mas também decisões impulsivas que trouxeram consequências. Suas escolhas afetaram seus relacionamentos e contribuíram para o aumento dos conflitos com os filisteus.",
                        ...
                        topicos: [

                            {
                                ...
                                texto:
                                    "Devido à confusão durante o banquete do casamento e ao desaparecimento de Sansão, o pai da noiva deu-a ao companheiro de honra para preservar a reputação da família (Jz 14.20). Depois de algum tempo, Sansão retornou para visitar a mulher e consumar o casamento. Levou um cabrito como sinal de paz e reconciliação, mas descobriu que ela havia sido entregue a outro homem. O pai da mulher tentou explicar a situação e propôs que Sansão se casasse com sua filha mais nova. Sansão não aceitou e, tomado de ira, declarou-se inocente do que faria a seguir (Jz 15.1-3). Suas atitudes anteriores haviam contribuído para aquela situação.",

                                aplicacao:
                                    "Escolhas equivocadas podem gerar consequências que não podem ser ignoradas. Antes de tomar decisões, precisamos considerar seus efeitos e buscar a direção de Deus.",
...

                            {
                                ...
                                texto:
                                    "Sansão pegou trezentas raposas e as soltou nas searas dos filisteus com fogo em suas caudas, destruindo plantações e causando grande prejuízo (Jz 15.4-8). A atitude provocou uma sequência de retaliações. Os filisteus mataram a mulher de Sansão e seu pai, e Sansão reagiu novamente com violência. Ele agiu sozinho, seguindo seus próprios objetivos e alimentando um ciclo de vingança.",

                                aplicacao:
                                    "Não permita que a ira determine suas atitudes. Em situações de conflito, escolha agir com sabedoria, domínio próprio e temor de Deus.",

                                destaque:
                                    "A vingança alimenta um ciclo de violência e destruição."
                            },

                            {
                                ...
                                texto:
                                    "Quando os filisteus se acamparam no território de Judá para capturar Sansão, os homens de Judá decidiram prendê-lo e entregá-lo aos inimigos (Jz 15.9-13). Em vez de protegê-lo como compatriota, preferiram evitar o confronto com os filisteus. Essa atitude mostra como o povo de Deus pode agir de maneira equivocada quando permite que o medo domine suas decisões. A Bíblia nos chama a carregar as cargas uns dos outros e promover restauração (Gl 6.1,2; Ef 4.29-32).",

                                aplicacao:
                                    "Não seja indiferente diante da dificuldade de um irmão. Procure ajudá-lo, aconselhá-lo e interceder por ele.",

                                destaque:
                                    "O povo de Deus deve proteger e sustentar seus irmãos, não entregá-los ao adversário."
                            },

                            {
                                ...
                                texto:
                                    "Amarrado e entregue aos filisteus, o Espírito do Senhor se apoderou de Sansão. Ele rompeu as cordas e, tomando uma queixada de jumento como arma, matou mil homens do exército filisteu (Jz 15.14-17). Depois da vitória, Sansão ficou extremamente sedento e clamou ao Senhor por ajuda. Deus respondeu ao seu clamor e providenciou água para ele (Jz 15.18,19). A cena mostra que, mesmo depois de grandes vitórias, Sansão continuava dependendo de Deus.",

                                aplicacao:
                                    "Nunca permita que uma vitória faça você esquecer sua dependência de Deus. Quanto maiores forem suas conquistas, maior deve ser sua gratidão ao Senhor.",

                                destaque:
                                    "Mesmo depois de grandes vitórias, o ser humano continua dependendo de Deus."
                            }
...

                    {
                        ...
                        introducao:
                            "Apesar de sua grande força física, Sansão demonstrava fragilidade no controle de seus desejos e na escolha de seus relacionamentos. Suas decisões nessa área colocaram sua vida e seu propósito em grande perigo.",
                        ...
                        topicos: [

                            {
                                ...
                                texto:
                                    "Sansão era fisicamente forte, mas moralmente vulnerável. Em Gaza, relacionou-se com uma prostituta e novamente colocou sua vida em risco (Jz 16.1-3). Mesmo conseguindo escapar de seus inimigos por causa de sua força, sua conduta revelava uma fraqueza que precisava ser enfrentada. Paulo orienta claramente: 'Fugi da prostituição' (1Co 6.18).",

                                aplicacao:
                                    "Não confie apenas na sua força de vontade. Afaste-se de situações, ambientes e comportamentos que possam conduzi-lo ao pecado.",

                                destaque:
                                    "A força física não vence a fraqueza moral."
                            },

                            {
                                ...
                                texto:
                                    "Sansão se apaixonou por Dalila, que foi subornada pelos líderes filisteus para descobrir o segredo de sua força (Jz 16.4-17). Ela insistiu até que Sansão revelou que sua força estava relacionada ao seu nazireado e que, se seus cabelos fossem cortados, ele perderia sua força. Sansão brincou repetidamente com o perigo e não percebeu que estava diante de alguém que buscava sua destruição.",

                                aplicacao:
                                    "Tenha discernimento ao escolher as pessoas com quem compartilha seus assuntos mais íntimos. Nem toda proximidade significa confiança.",

                                destaque:
                                    "A falta de discernimento nos relacionamentos pode conduzir à destruição."
                            },

                            {
                                ...
                                texto:
                                    "Dalila consumou sua traição enquanto Sansão dormia. Depois que seus cabelos foram cortados, ele acordou acreditando que escaparia como das outras vezes, mas não sabia que o Senhor já havia se retirado dele (Jz 16.20). Os filisteus o prenderam, furaram seus olhos e o levaram para Gaza, onde passou a trabalhar no cárcere (Jz 16.21). O homem que havia sido usado para libertar Israel agora estava escravizado.",

                                aplicacao:
                                    "Não trate o pecado como algo pequeno. Se perceber que está caminhando em uma direção errada, volte-se para Deus enquanto há oportunidade.",

                                destaque:
                                    "A persistência no pecado pode transformar liberdade em escravidão."
                            }
...

                    {
                        ...
                        introducao:
                            "Mesmo depois de sua queda, Sansão teve uma última oportunidade de clamar ao Senhor. Sua história termina com uma demonstração de que Deus continua soberano e pode agir mesmo em meio à fraqueza humana.",
                        ...
                        topicos: [

                            {
                                ...
                                texto:
                                    "Os filisteus celebraram sua vitória sobre Sansão, oferecendo uma grande festa ao seu deus Dagom (Jz 16.23-25). Eles zombaram do antigo libertador de Israel e fizeram dele uma diversão. Sansão havia perdido sua liberdade, sua visão e sua dignidade. Sua história mostra o perigo de confiar excessivamente em si mesmo.",

                                aplicacao:
                                    "Não permita que conquistas, habilidades ou experiências passadas produzam autossuficiência. Reconheça diariamente sua dependência de Deus.",

                                destaque:
                                    "A autoconfiança pode transformar força em humilhação."
                            },

                            {
                                ...
                                texto:
                                    "Cego e preso, Sansão clamou ao Senhor pedindo força uma última vez (Jz 16.26-31). Ele reconheceu sua necessidade de Deus e pediu que o Senhor se lembrasse dele. Posicionado entre as colunas do templo dos filisteus, Sansão as empurrou com força, derrubando a estrutura e causando a morte de muitos filisteus, inclusive a sua própria morte. Na sua morte, matou mais homens do que durante toda a sua vida (Jz 16.30).",

                                aplicacao:
                                    "Quando reconhecer sua insuficiência, não permaneça distante de Deus. Clame ao Senhor e dependa dEle.",

                                destaque:
                                    "Na fraqueza, Sansão voltou a clamar pela força de Deus."
                            },

                            {
                                ...
                                texto:
                                    "Apesar de suas muitas falhas, Sansão é mencionado entre os heróis da fé em Hebreus 11.32. A passagem também afirma que alguns, pela fé, da fraqueza tiraram forças (Hb 11.34). Sansão não deve ser imitado em seus erros, mas sua história mostra que a graça de Deus pode agir por meio de pessoas imperfeitas que reconhecem sua necessidade do Senhor.",

                                aplicacao:
                                    "Não use suas limitações como desculpa para permanecer distante de Deus. Reconheça suas fraquezas e permita que a graça do Senhor conduza sua vida.",

                                destaque:
                                    "A graça de Deus pode manifestar-se mesmo em meio às nossas limitações."
                            }
                ...
                conclusao:
                    "A história de Sansão, embora marcada por vitórias impressionantes e derrotas dolorosas, nos lembra que a verdadeira força não está na capacidade física nem nos talentos pessoais, mas na dependência constante de Deus.\n\nSeu percurso revela como a autossuficiência e o flerte com o pecado conduzem à queda, enquanto a humildade e o clamor ao Senhor abrem espaço para que a graça se manifeste, mesmo nos momentos finais.\n\nSansão não foi um exemplo de santidade, mas sua vida e morte testificam que Deus pode transformar fraqueza em instrumento de juízo e redenção.",
                ...
                perguntas: [

                    {
                        nivel: "🟢 Fácil",
                        pergunta:
                            "Qual era a principal característica física de Sansão?",
                        resposta:
                            "Sua grande força física, que estava relacionada à ação de Deus em sua vida."
                    },

                    {
                        ...
                        resposta:
                            "Porque os filisteus haviam se acampado em Judá para capturá-lo, e os homens de Judá decidiram prendê-lo e entregá-lo."
                    },

                    {
                        nivel: "🟡 Média",
                        pergunta:
                            "Qual foi a consequência de Sansão revelar a Dalila o segredo de sua força?",
                        resposta:
                            "Dalila providenciou que seu cabelo fosse cortado, e Sansão perdeu sua força, sendo capturado, cegado e escravizado pelos filisteus."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "Qual foi o principal problema espiritual de Sansão, apesar de sua grande força física?",
                        resposta:
                            "Sua falta de domínio próprio e sua tendência de agir segundo seus próprios desejos, especialmente nos relacionamentos e diante das tentações."
                    },
    ...
    juvenis: {
        ...
        "3": {
            ...
            "10": {
                ...
                pontoPrincipal:
                    "Quem espera no Senhor encontra forças renovadas para continuar caminhando, mesmo diante do cansaço e das dificuldades.",
                ...
                objetivos: [
                    ...
                    "DEMONSTRAR a mensagem de estímulo do apóstolo aos jovens, e o que acontece quando, na igreja, existem líderes mercenários.",
                    "ENTENDER os cuidados e desafios da juventude cristã."
                ],

                introducao:
                    "A Primeira Epístola de João, ao que tudo indica, foi escrita por volta do ano 90 d.C., para os crentes que moravam na Ásia Menor, região onde estavam as sete igrejas do Apocalipse (Ap 2.1-3.22). Segundo alguns estudiosos, a carta mais se parece com um tratado cristão, assemelhando-se muito ao Evangelho escrito pelo mesmo autor, diferente de 2 e 3 João, que seguem rigorosamente o padrão de uma epístola. O tema central é o amor, assunto recorrentemente tratado pelo autor, tanto em seus escritos, quanto em suas pregações. João, outrora denominado, pelo próprio Jesus, de “filho do trovão” (Mc 3.17), por seu gênio impetuoso, no futuro tornou-se conhecido também como o “discípulo amado” (Jo 19.26; 20.2; 21.7, 20). Aliás, diz a tradição cristã que João era pregador de uma mensagem só: “Filhinhos, amai-vos uns aos outros.”",
                ...
                desenvolvimento: [

                    {
                        ...
                        introducao:
                            "A Primeira Epístola de João destaca o amor como uma marca essencial da vida cristã.",

                        topicos: [

                            {
                                titulo:
                                    "1. O amor é central na mensagem de João",

                                texto:
                                    "João apresenta o amor como um elemento fundamental da vida cristã. Sua mensagem mostra que aquele que conhece a Deus deve demonstrar esse conhecimento por meio da maneira como trata as pessoas.\n\nMarcos 3.17 registra: “E a Tiago, filho de Zebedeu, e a João, irmão de Tiago, aos quais pôs o nome de Boanerges, que significa: Filhos do trovão.” João inicialmente era conhecido por seu temperamento impetuoso, mas sua caminhada com Cristo produziu transformação em seu caráter.\n\nJoão 13.34 registra: “Um novo mandamento vos dou: Que vos ameis uns aos outros; como eu vos amei a vós, que também vós uns aos outros vos ameis.”\n\nO amor cristão não é apenas sentimento, mas uma atitude que demonstra a transformação realizada por Deus.",

                                aplicacao:
                                    "Não permita que conflitos, diferenças ou mágoas façam você abandonar o amor cristão. Demonstre, por meio de suas atitudes, que Cristo está transformando seu coração.",

                                destaque:
                                    "A maturidade espiritual não é demonstrada apenas pelo conhecimento bíblico, mas também pela maneira como tratamos as pessoas."
                            },

                            {
                                ...
                                texto:
                                    "A Bíblia ensina que o verdadeiro amor tem sua origem em Deus. 1 João 4.7 declara: “Amados, amemo-nos uns aos outros; porque o amor é de Deus; e qualquer que ama é nascido de Deus e conhece a Deus.”\n\nIsso significa que o amor deve fazer parte da identidade daqueles que pertencem ao Senhor. O cristão é chamado para refletir o caráter de Deus em seus relacionamentos.\n\nA experiência de João demonstra que Deus pode transformar profundamente uma pessoa. O homem que possuía um temperamento impetuoso tornou-se conhecido como o discípulo amado.",

                                aplicacao:
                                    "Permita que o amor de Deus transforme sua maneira de pensar, falar e agir com outras pessoas.",

                                destaque:
                                    "Deus transforma o caráter daqueles que caminham com Ele."
                            }
                    ...
                    {
                        titulo:
                            "II. UMA MENSAGEM AOS JOVENS",

                        introducao:
                            "João dirige uma mensagem especial aos jovens, destacando sua força espiritual, sua permanência na Palavra e sua vitória sobre o Maligno.",
                        ...
                        topicos: [

                            {
                                ...
                                texto:
                                    "João afirma aos jovens: “Eu vos escrevi, jovens, porque sois fortes, e a palavra de Deus está em vós, e já vencestes o Maligno” (1 Jo 2.14).\n\nA força mencionada não deve ser entendida apenas como força física. O jovem cristão precisa desenvolver força espiritual para permanecer firme diante das tentações e dos ataques do Inimigo.\n\nEfésios 6.10 também nos orienta: “No demais, irmãos meus, fortalecei-vos no Senhor e na força do seu poder.”\n\nA verdadeira força do jovem não está apenas em sua capacidade física, inteligência ou habilidades, mas em sua dependência do Senhor.",

                                aplicacao:
                                    "Não confie somente em sua própria capacidade. Busque diariamente a força que vem do Senhor.",

                                destaque:
                                    "A verdadeira força do jovem está em permanecer firme diante dos ataques do Inimigo."
                            },

                            {
                                titulo:
                                    "2. A Palavra de Deus está em vós",

                                texto:
                                    "João também destaca que a Palavra de Deus estava nos jovens. Isso mostra que a força espiritual está diretamente relacionada ao relacionamento com as Escrituras.\n\nSalmos 119.9 pergunta: “Como purificará o jovem o seu caminho?” E responde mostrando a importância de observar a Palavra de Deus.\n\nSalmos 119.11 declara: “Escondi a tua palavra no meu coração, para eu não pecar contra ti.”\n\nQuando a Palavra está guardada no coração, ela orienta as decisões, fortalece diante das tentações e ajuda o jovem a discernir aquilo que agrada ao Senhor.",

                                aplicacao:
                                    "Não deixe a Bíblia ser apenas um livro que você possui. Leia, medite, memorize e pratique a Palavra de Deus diariamente.",

                                destaque:
                                    "A Palavra de Deus fortalece o jovem e orienta suas escolhas."
                            },

                            {
                                titulo:
                                    "3. Vencestes o Maligno",

                                texto:
                                    "João afirma que os jovens haviam vencido o Maligno. Essa vitória está relacionada à força espiritual e à permanência na Palavra de Deus.\n\nO jovem cristão enfrenta tentações, pressões e influências que podem tentar afastá-lo do Senhor. Por isso, precisa permanecer vigilante e dependente de Deus.\n\nTiago 4.7 ensina: “Sujeitai-vos, pois, a Deus, resisti ao diabo, e ele fugirá de vós.”\n\nEfésios 6.13 também orienta o cristão a tomar toda a armadura de Deus para permanecer firme no dia mau.",

                                aplicacao:
                                    "Permaneça próximo de Deus e use a Palavra como fundamento para enfrentar as tentações.",

                                destaque:
                                    "O jovem que permanece na Palavra encontra força para vencer as tentações."
                            }
                    ...
                    {
                        titulo:
                            "III. UMA ADVERTÊNCIA: NÃO AMEIS O MUNDO",

                        introducao:
                            "Após tecer elogios aos jovens, o Espírito Santo traz uma forte advertência: não ameis o mundo (1 Jo 2.15). O amor ao mundo é incompatível com a fé cristã (Tg 4.4). Ele é sorrateiro, perigoso, pois pode surgir com o passar dos dias. Paulo, por exemplo, fala de um obreiro, Demas, o qual, outrora fiel (Cl 4.14; Fm 24), amou o mundo e abandonou Paulo (2 Tm 4.10). Dessa forma, devemos estar vigilantes. Todo cuidado é pouco!",
                        ...
                        topicos: [

                            {
                                ...
                                texto:
                                    "A expressão concupiscência da carne aponta para desejos intensos que podem conduzir a pessoa ao pecado. Esses desejos precisam estar submetidos à vontade de Deus e ao controle do Espírito Santo.\n\nGálatas 5.16 ensina: “Andai em Espírito e não cumprireis a concupiscência da carne.”\n\nGálatas 5.24 também mostra que aqueles que pertencem a Cristo crucificaram a carne com suas paixões e concupiscências.\n\nOs desejos não devem governar nossa vida. O cristão precisa aprender a dizer não ao pecado e a viver de acordo com a vontade do Senhor.",

                                aplicacao:
                                    "Não permita que desejos contrários à vontade de Deus controlem suas decisões. Busque viver diariamente sob a direção do Espírito Santo.",

                                destaque:
                                    "Nossos desejos precisam estar submetidos à vontade de Deus."
                            },

                            {
                                ...
                                texto:
                                    "A concupiscência dos olhos está relacionada ao desejo que nasce quando contemplamos aquilo que não devemos possuir ou desejar. O pecado pode começar no olhar e crescer dentro do coração.\n\nEm Gênesis 3.6, Eva viu que a árvore era boa para comer, agradável aos olhos e desejável para dar entendimento. O olhar alimentou o desejo e contribuiu para a desobediência.\n\nSalmos 101.3 apresenta uma decisão importante: “Não porei coisa má diante dos meus olhos.”\n\nPor isso, precisamos guardar aquilo que permitimos entrar através dos nossos olhos.",

                                aplicacao:
                                    "Tenha cuidado com aquilo que você escolhe olhar, assistir e alimentar em sua mente. Nem tudo aquilo que aparece diante dos seus olhos deve permanecer em seu coração.",

                                destaque:
                                    "Quem deseja permanecer fiel a Deus precisa aprender a guardar seus olhos."
                            },

                            {
                                ...
                                texto:
                                    "A soberba da vida está relacionada à arrogância, à busca de reconhecimento e à confiança excessiva em si mesmo. A pessoa passa a acreditar que não precisa depender de Deus.\n\nProvérbios 16.18 declara: “A soberba precede a ruína, e a altivez do espírito precede a queda.”\n\nO jovem rico, apresentado em Mateus 19.21-22, possuía muitos bens e não conseguiu abrir mão deles para seguir plenamente a Jesus. Seus recursos acabaram revelando aquilo que ocupava o primeiro lugar em seu coração.\n\nA verdadeira grandeza não está em possuir muito ou ser admirado pelas pessoas, mas em viver humildemente diante de Deus.",

                                aplicacao:
                                    "Não permita que bens, talentos, aparência ou reconhecimento façam você depender menos de Deus.",

                                destaque:
                                    "A soberba conduz à autossuficiência, enquanto a humildade nos mantém dependentes de Deus."
                            }
                ...
                perguntas: [

                    {
                        nivel: "🟢 Fácil",
                        pergunta:
                            "Qual é a principal advertência apresentada em 1 João 2.15?",
                        resposta:
                            "Não amar o mundo nem as coisas que há no mundo, pois o amor ao mundo é incompatível com o amor do Pai."
                    },

                    {
                        nivel: "🟡 Média",
                        pergunta:
                            "Quais são as três coisas mencionadas em 1 João 2.16?",
                        resposta:
...

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "O que significa a concupiscência da carne?",
                        resposta:
                            "São desejos intensos provenientes da natureza humana caída que precisam ser controlados e submetidos à vontade de Deus e à direção do Espírito Santo."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "Como a concupiscência dos olhos pode conduzir ao pecado?",
                        resposta:
                            "Ela pode começar quando a pessoa olha de maneira cobiçosa para aquilo que é proibido, alimentando o desejo no coração até que ele resulte em uma atitude de desobediência, como aconteceu com Eva."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "Qual é o perigo da soberba da vida e o que podemos aprender com o jovem rico?",
                        resposta:
    ...
    adolescentes: {
        ...
        "3": {
            ...
            "10": {
                ...
                titulo: "O TERCEIRO DIÁRIO DE VIAGEM",
                ...
                pontoPrincipal:
                    "O terceiro diário de viagem de Paulo revela a importância de anunciar o Evangelho, ensinar a Palavra e conduzir pessoas ao verdadeiro conhecimento de Jesus Cristo.",
                ...
                objetivos: [
                    ...
                    "🏛️ MOSTRAR como foi a recepção de Paulo em Jerusalém."
                ...
                horaAprender: {
                    ...
                    secoes: [

                        {
                            ...
                            topicos: [

                                {
                                    ...
                                    texto:
                                        "Apolo havia ensinado sobre Jesus, porém conhecia apenas o batismo de João. Quando Paulo encontrou alguns discípulos em Éfeso, ensinou-lhes de maneira mais completa sobre a fé em Cristo e sobre o Espírito Santo. Depois de receberem o ensino, Paulo orou e impôs as mãos sobre eles, e eles receberam o Espírito Santo.",

                                    pontoPrincipal:
                                        "📌 Ponto principal Paulo ensinou os discípulos de Éfeso sobre o Batismo no Espírito Santo.",

                                    versiculos: [

                                        {
                                            referencia: "Atos 19.6",
                                            texto:
                                                "E, impondo-lhes Paulo as mãos, veio sobre eles o Espírito Santo; e falavam línguas e profetizavam.",
                                            explicacao:
                                                "O texto mostra que os discípulos receberam o Espírito Santo depois da oração e imposição das mãos de Paulo."
                                        },

                                        {
                                            ...
                                            explicacao:
                                                "Jesus ordenou que seus discípulos ensinassem e anunciassem a mensagem do Evangelho a todas as pessoas."
                                        },

                                        {
                                            referencia: "Atos 19.7",
                                            texto:
                                                "E estes eram, ao todo, uns doze varões.",
                                            explicacao:
                                                "O relato de Atos informa que havia aproximadamente doze homens entre aqueles discípulos."
                                        }

                                    ],

                                    exortacao:
                                        "📣 Exortação prática Precisamos estar dispostos a aprender mais sobre a Palavra de Deus e crescer espiritualmente. O conhecimento correto da fé deve nos levar a uma vida cada vez mais comprometida com Cristo.",

                                    reflexao:
                                        "💭 Reflexão para a vida cristã Estamos realmente buscando conhecer melhor a Palavra de Deus ou estamos satisfeitos apenas com aquilo que já aprendemos?",

                                    pontosPrincipais: [

                                        "📖 Precisamos aprender a verdade.",

                                        "🕊️ Devemos buscar crescimento espiritual.",

                                        "🙏 O ensino bíblico deve produzir uma fé viva."

                                    ],

                                    palavrasChave: [

                                        "📖 Ensino — Instrução baseada na Palavra de Deus.",

                                        "🕊️ Espírito Santo — Aquele que atua na vida dos que pertencem a Cristo.",

                                        "🙏 Crescimento — Desenvolvimento contínuo na fé e no conhecimento de Deus."
                                ...
                                {
                                    titulo:
                                        "⚔️ 1.2 O Enfrentamento de Espíritos Malignos",

                                    texto:
                                        "Durante sua permanência em Éfeso, Paulo realizou milagres extraordinários, e muitas pessoas foram impactadas pelo poder de Deus. Alguns homens, porém, tentaram imitar aquilo que Paulo fazia. Os filhos de Ceva tentaram expulsar um espírito maligno usando o nome de Jesus, mas não possuíam uma verdadeira relação com Cristo. O espírito maligno os enfrentou, e o episódio levou muitas pessoas a reconhecerem o poder de Deus. Como resultado, vários que praticavam magia abandonaram essas práticas e queimaram seus livros.",

                                    pontoPrincipal:
                                        "📌 Ponto principal O poder de Deus levou pessoas a abandonar as práticas de magia.",

                                    versiculos: [

                                        {
                                            referencia: "Atos 19.11",
                                            texto:
                                                "E Deus, pelas mãos de Paulo, fazia maravilhas extraordinárias.",
                                            explicacao:
                                                "Deus demonstrou seu poder através do ministério de Paulo, confirmando a mensagem do Evangelho."
                                        },

                                        {
                                            referencia: "Atos 19.15",
                                            texto:
                                                "Conheço a Jesus e bem sei quem é Paulo; mas vós, quem sois?",
                                            explicacao:
                                                "O espírito maligno reconheceu Jesus e Paulo, mostrando que o nome de Jesus não deveria ser usado como uma simples fórmula."
                                        },

                                        {
                                            referencia: "Atos 19.20",
                                            texto:
                                                "Assim, a palavra do Senhor crescia poderosamente e prevalecia.",
                                            explicacao:
                                                "A Palavra de Deus avançou e produziu transformação na vida das pessoas."
                                        }

                                    ],

                                    exortacao:
                                        "📣 Exortação prática Não devemos brincar com práticas espirituais contrárias à Palavra de Deus nem tentar usar o nome de Jesus como uma fórmula. Nossa confiança deve estar no Senhor e em sua Palavra.",

                                    reflexao:
                                        "💭 Reflexão para a vida cristã O Evangelho verdadeiro transforma escolhas. Quando Cristo ocupa o centro da nossa vida, precisamos abandonar aquilo que contradiz a vontade de Deus.",

                                    pontosPrincipais: [

                                        "⚔️ Deus demonstrou seu poder em Éfeso.",

                                        "🚫 As práticas contrárias à fé foram abandonadas.",

                                        "📖 A Palavra de Deus prevaleceu."

                                    ],

                                    palavrasChave: [

                                        "⚔️ Confronto — Enfrentamento das práticas contrárias à vontade de Deus.",

                                        "🔥 Poder — Manifestação da ação de Deus.",

                                        "📖 Palavra — Verdade de Deus que orienta e transforma a vida."
                        ...
                        {
                            titulo:
                                "⚔️ 2 — O CONFLITO RELIGIOSO E ECONÔMICO",

                            introducao:
                                "O crescimento do Evangelho em Éfeso provocou mudanças profundas na sociedade. A transformação das pessoas começou a afetar também atividades econômicas ligadas à idolatria.",

                            topicos: [

                                {
                                    titulo:
                                        "⚔️ 2.1 — O impacto do Evangelho na sociedade",

                                    texto:
                                        "A pregação do Evangelho em Éfeso produziu uma transformação tão grande que começou a afetar também a economia da cidade. Muitas pessoas abandonaram a idolatria e passaram a seguir a Cristo. Isso prejudicou os negócios daqueles que lucravam com a fabricação e venda de objetos relacionados ao culto da deusa Diana.",

                                    pontoPrincipal:
                                        "📌 Ponto principal A transformação causada pelo Evangelho pode alcançar não apenas a vida espiritual, mas também os costumes e as estruturas da sociedade.",

                                    versiculos: [

                                        {
                                            referencia: "Atos 19.19",
                                            texto:
                                                "Também muitos dos que tinham praticado artes mágicas trouxeram os seus livros e os queimaram diante de todos.",
                                            explicacao:
                                                "A decisão de abandonar as práticas de magia demonstrava que aquelas pessoas haviam compreendido que não poderiam continuar vivendo da mesma maneira depois de conhecerem a Cristo."
                                        },

                                        {
                                            ...
                                            texto:
                                                "Assim, a palavra do Senhor crescia poderosamente e prevalecia.",
                                            explicacao:
                                                "O crescimento da Palavra de Deus demonstrava que o Evangelho estava produzindo uma transformação verdadeira na cidade."
                                        },

                                        {
                                            referencia: "Atos 19.26",
                                            texto:
                                                "E bem vedes e ouvis que não só em Éfeso, mas até quase em toda a Ásia, este Paulo tem persuadido e apartado uma grande multidão, dizendo que não são deuses os que se fazem com as mãos.",
                                            explicacao:
                                                "A mensagem de Paulo confrontava diretamente a idolatria e levava muitas pessoas a abandonar a confiança em deuses feitos por mãos humanas."
                                        }

                                    ],

                                    exortacao:
                                        "📣 Exortação prática O Evangelho deve produzir mudanças reais em nossa vida. Quando conhecemos a Cristo, algumas práticas, hábitos e escolhas precisam ser abandonados para que nossa vida esteja de acordo com a Palavra de Deus.",

                                    reflexao:
                                        "💭 Reflexão para a vida cristã Se alguém observar nossas escolhas, amizades, palavras e atitudes, perceberá que o Evangelho realmente transformou nossa vida?",

                                    pontosPrincipais: [

                                        "📖 O Evangelho transforma vidas.",

                                        "🚫 A verdadeira conversão produz abandono de práticas contrárias à Palavra.",

                                        "🌍 Uma vida transformada pode influenciar a sociedade."

                                    ],

                                    palavrasChave: [

                                        "🔥 Transformação — Mudança produzida pela ação do Evangelho.",

                                        "🚫 Idolatria — Adoração ou confiança direcionada a algo que ocupa o lugar de Deus.",

                                        "🌍 Impacto — Influência que uma vida transformada pode exercer sobre outras pessoas."
                                ...
                                {
                                    titulo:
                                        "🔥 2.2 — A revolta dos artesãos de Éfeso",

                                    texto:
                                        "O crescimento do Evangelho em Éfeso começou a afetar diretamente os interesses daqueles que lucravam com a idolatria. Demétrio, um fabricante de pequenas imagens de prata da deusa Diana, percebeu que a pregação de Paulo estava prejudicando seus negócios. Ele reuniu outros artesãos e provocou uma grande revolta contra os cristãos. A multidão ficou agitada, e a cidade entrou em confusão. Mesmo diante dessa oposição, a mensagem do Evangelho continuou avançando.",

                                    pontoPrincipal:
                                        "📌 Ponto principal O avanço do Evangelho pode provocar oposição quando interesses econômicos e religiosos são confrontados pela verdade.",

                                    versiculos: [

                                        {
                                            referencia: "Atos 19.27",
                                            texto:
                                                "E não somente há perigo de que a nossa profissão caia em descrédito, mas também de que o templo da grande deusa Diana seja estimado em nada.",
                                            explicacao:
                                                "Demétrio estava preocupado principalmente com a perda dos seus negócios e com a diminuição da influência da idolatria."
                                        },

                                        {
                                            referencia: "Atos 19.28",
                                            texto:
                                                "Ouvindo isto, encheram-se de ira e clamaram, dizendo: Grande é a Diana dos efésios!",
                                            explicacao:
                                                "Aqueles que lucravam com a idolatria reagiram com violência quando perceberam que o Evangelho estava mudando a maneira de pensar das pessoas."
                                        },

                                        {
                                            referencia: "Atos 19.32",
                                            texto:
                                                "Uns, pois, gritavam de uma maneira, outros, de outra; porque a assembleia estava confusa, e a maior parte deles não sabia por que causa se tinham ajuntado.",
                                            explicacao:
                                                "A confusão mostra como a revolta foi alimentada pela agitação e pelos interesses daqueles que se sentiram ameaçados."
                                        }

                                    ],

                                    exortacao:
                                        "📣 Exortação prática Quando o Evangelho transforma verdadeiramente uma vida, algumas pessoas podem se opor. Não devemos abandonar nossa fé por causa da pressão ou da oposição, mas permanecer firmes em Cristo.",

                                    reflexao:
                                        "💭 Reflexão para a vida cristã Se nossa fé confrontar hábitos ou interesses que não agradam a Deus, estaremos dispostos a permanecer firmes mesmo diante da pressão?",

                                    pontosPrincipais: [

                                        "🔥 O Evangelho confronta interesses contrários à verdade.",

                                        "⚔️ A fé cristã pode enfrentar oposição.",

                                        "🛡️ Precisamos permanecer firmes em Cristo."

                                    ],

                                    palavrasChave: [

                                        "🏛️ Diana — Deusa venerada em Éfeso e centro de importante culto local.",

                                        "💰 Interesses — Ganhos e vantagens que podem entrar em conflito com a fé.",

                                        "🛡️ Perseverança — Permanecer firme na fé mesmo diante da oposição."
                        ...
                        {
                            titulo:
                                "🏛️ 3 — A PARADA FINAL EM JERUSALÉM",

                            introducao:
                                "Depois de permanecer em Éfeso e enfrentar diversos desafios, Paulo seguiu sua jornada em direção a Jerusalém. Mesmo sabendo que enfrentaria dificuldades, permaneceu fiel à missão que Deus havia colocado em suas mãos.",

                            topicos: [

                                {
                                    titulo:
                                        "🏛️ 3.1 A chegada de Paulo a Jerusalém",

                                    texto:
                                        "Paulo chegou a Jerusalém e foi recebido pelos irmãos com alegria. Ele contou detalhadamente tudo o que Deus havia feito entre os gentios por meio do seu ministério. Porém, também enfrentou rumores e falsas acusações. Para demonstrar que não estava ensinando os judeus a abandonar a Lei de Moisés, Paulo participou de um ritual de purificação. Mesmo assim, quando foi visto no templo, alguns judeus levantaram acusações contra ele. A multidão se agitou, Paulo foi arrastado para fora do templo e acabou sendo preso. Ainda diante dessas circunstâncias, Paulo permaneceu fiel à sua missão.",

                                    pontoPrincipal:
                                        "📌 Ponto principal Paulo permaneceu fiel à sua missão mesmo diante de falsas acusações e perseguição.",

                                    versiculos: [

                                        {
                                            referencia: "Atos 21.17",
                                            texto:
                                                "E, quando chegamos a Jerusalém, os irmãos nos receberam de muito boa vontade.",
                                            explicacao:
                                                "A chegada de Paulo foi marcada pela recepção dos irmãos, demonstrando a comunhão existente entre os cristãos."
                                        },

                                        {
                                            referencia: "Atos 21.19",
                                            texto:
                                                "E, havendo-os saudado, contou-lhes por miúdo o que por seu ministério Deus fizera entre os gentios.",
                                            explicacao:
                                                "Paulo testemunhou sobre tudo aquilo que Deus havia realizado entre os gentios por meio do seu ministério."
                                        },

                                        {
                                            referencia: "Atos 21.30",
                                            texto:
                                                "E toda a cidade se alvoroçou, e o povo concorreu, e, tomando a Paulo, o arrastaram para fora do templo; e logo as portas se fecharam.",
                                            explicacao:
                                                "Paulo enfrentou uma grande revolta e foi arrastado para fora do templo, sendo posteriormente preso."
                                        }

                                    ],

                                    exortacao:
                                        "📣 Exortação prática Nem sempre fazer a vontade de Deus significa receber aprovação das pessoas. Devemos permanecer fiéis à missão que Deus nos confiou, mesmo quando somos injustamente criticados, acusados ou perseguidos.",

                                    reflexao:
                                        "💭 Reflexão para a vida cristã Como reagimos quando somos mal compreendidos ou injustamente acusados? A atitude de Paulo nos ensina que nossa fidelidade a Deus não deve depender da aprovação das pessoas.",

                                    pontosPrincipais: [

                                        "🤝 A igreja recebeu Paulo com alegria.",

                                        "🌍 Paulo testemunhou sobre a obra de Deus entre os gentios.",

                                        "🛡️ Paulo permaneceu firme diante da perseguição."

                                    ],

                                    palavrasChave: [

                                        "🤝 Comunhão — Relacionamento de união e participação entre os irmãos.",

                                        "🌍 Missão — Compromisso de anunciar as Boas-Novas de Jesus Cristo.",

                                        "🛡️ Fidelidade — Permanecer firme em Deus mesmo diante das dificuldades."
                ...
                conclusao:
                    "📖 CONCLUSÃO\n🙏 O ministério do Apóstolo Paulo foi conduzido por Deus. Mesmo quando a situação parecia complicada, havia um propósito maior: a pregação do Evangelho do Senhor Jesus e a salvação de almas. ✝️🌍",
                ...
                perguntas: [

                    {
                        nivel: "🟢 Fácil",
                        pergunta:
                            "Quanto tempo Paulo permaneceu em Éfeso durante sua terceira viagem missionária?",
                        resposta:
                            "Paulo permaneceu três anos em Éfeso."
                    },

                    {
                        nivel: "🟡 Média",
                        pergunta:
                            "O que aconteceu com os discípulos de Éfeso depois que Paulo lhes ensinou sobre o Espírito Santo?",
                        resposta:
                            "Paulo orou e impôs as mãos sobre eles; então receberam o Espírito Santo, falaram em línguas e profetizaram."
                    },

                    {
                        nivel: "🟠 Média",
                        pergunta:
                            "Por que os artesãos de Éfeso ficaram revoltados com Paulo?",
                        resposta:
                            "Porque a pregação do Evangelho estava levando muitas pessoas a abandonar a idolatria, prejudicando o comércio de objetos relacionados ao templo de Diana."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "Qual foi o resultado do confronto envolvendo os filhos de Ceva, que tentaram usar o nome de Jesus sem terem autoridade para isso?",
                        resposta:
                            "O espírito maligno os enfrentou, afirmando conhecer Jesus e Paulo. O episódio mostrou que o nome de Jesus não deveria ser usado como uma fórmula ou instrumento de poder."
                    },

                    {
                        nivel: "🔴 Difícil",
                        pergunta:
                            "Por que Paulo aceitou participar do ritual de purificação em Jerusalém?",
                        resposta:
                            "Para demonstrar que eram falsas as acusações de que ele ensinava os judeus a abandonar a Lei de Moisés e, assim, evitar um conflito desnecessário entre os irmãos."
                    }
...
titulo: "Jefté batalha contra os efraimitas",
...
leituraBiblica:
    ...
    "Ensinar às crianças que a falta de união, o orgulho e a falta de companheirismo podem causar brigas e grandes problemas, enquanto o amor, o perdão e a união agradam a Deus."

],
          pontoPrincipal:
    "Deus quer que seus filhos vivam unidos, ajudando uns aos outros e resolvendo os problemas com amor.",
          introducao:
    "🟢 1. VAMOS COMEÇAR?\n\nReceba cada criança com alegria.\n\nPergunte: Como foi a semana? Alguém ajudou um amigo? Alguém precisou de ajuda? Já brigaram por coisa pequena?\n\nHoje vamos conhecer uma história da Bíblia em que duas partes do povo de Israel ficaram divididas. Uma briga acabou causando um problema muito maior. Vamos descobrir o que aconteceu e aprender por que Deus deseja que vivamos em união.\n\nFaça uma oração inicial.",
          desenvolvimento: [
            {
    titulo: "🎵 2. MOMENTO DE LOUVOR",

    texto:
        "Escolha 1 ou 2 cânticos infantis que falem sobre amor, amizade, união, Igreja ou ajudar o próximo.\n\nDepois do louvor, faça uma oração curta."
},
            {
    titulo: "💰 3. MOMENTO DA OFERTA",

    texto:
        "Quando ofertamos, também estamos participando da obra de Deus. Cada um pode contribuir com alegria, não importa o tamanho da oferta.\n\nFaça a oferta e ore agradecendo a Deus."
},
            {
    titulo: "📖 4. RELEMBRANDO JEFTÉ",

    texto:
        "Pergunte às crianças quem se lembra de Jefté.\n\nJefté era um homem de Gileade e foi escolhido como líder de Israel. Os israelitas estavam sofrendo por causa dos amonitas, e Jefté liderou o povo na batalha. Deus deu a vitória a Israel. Depois da vitória, porém, surgiu um problema entre os próprios israelitas."
},
            {
    titulo: "📚 5. EXPLORANDO A HISTÓRIA",

    topicos: [

        {
            titulo: "⚔️ A BRIGA ENTRE EFRAIMITAS E GILEADITAS",

            texto:
                "Depois da vitória sobre os amonitas, os homens da tribo de Efraim foram falar com Jefté. Eles estavam zangados porque não tinham sido chamados para participar da batalha. Os efraimitas ameaçaram queimar a casa de Jefté com ele dentro. Jefté respondeu que havia pedido ajuda, mas eles não tinham vindo.\n\nO orgulho e as provocações fizeram o conflito aumentar.",

            reflexao:
                "Vocês acham justo alguém não querer ajudar e depois ficar bravo porque não participou da vitória?"
        }

    ]
},
{
    titulo: "😡 6. QUANDO A BRIGA FICA MAIOR",

    texto:
        "O conflito entre os efraimitas e os gileaditas aumentou até se transformar em uma guerra. Muitas pessoas morreram. A Bíblia relata que cerca de 42.000 efraimitas morreram.\n\n⚠️ Não precisamos entrar em detalhes sobre a violência. O mais importante é entender a consequência da falta de união e de diálogo.\n\nObserve esta sequência:\n\norgulho → provocações → falta de diálogo → briga → divisão → muitas mortes.\n\nEscreva no quadro:\n\nORGULHO + BRIGA + FALTA DE UNIÃO = GRANDES PROBLEMAS"
},
            {
    titulo: "🌊 7. O QUE ERA “CHIBOLETE”?",

    texto:
        "Depois da batalha, os gileaditas controlaram as passagens do rio Jordão. Quando alguém tentava atravessar, perguntavam se era efraimita. Se a pessoa dissesse que não era, pediam que falasse a palavra “Chibolete”. Os efraimitas pronunciavam “Sibolete”, porque não conseguiam falar corretamente a palavra. Assim, eram identificados.\n\nEssa situação mostra como a divisão entre os irmãos havia se tornado muito séria."
},
            {
    titulo: "❤️ 8. O QUE ESSA HISTÓRIA ENSINA PARA NÓS?",

    texto:
        "Pergunte às crianças: O que essa história tem a ver com a nossa vida?\n\nÀs vezes, uma pequena discussão entre crianças pode crescer quando ninguém quer pedir desculpas ou perdoar.\n\nExemplos:\n\n“Você não me chamou para brincar!”\n\n“Não vou mais falar com você!”\n\n“Você pegou meu lápis!”\n\n“Então não sou mais seu amigo!”\n\n🧩 EXEMPLO: Duas crianças estão montando um brinquedo. Uma pega uma peça que a outra queria usar. Elas começam a discutir, depois trocam palavras ruins e outras crianças entram na discussão.\n\nPergunte: Seria melhor conversar e resolver o problema?"
},
            {
    titulo: "🤝 9. O QUE É COMPANHEIRISMO?",

    texto:
        "Companheirismo significa ajudar, compartilhar, respeitar, ouvir, perdoar, trabalhar juntos e cuidar uns dos outros.\n\nCompanheiro não é aquele que só fica ao nosso lado quando tudo está bem. É aquele que também está disposto a ajudar quando precisamos."
},
            {
    titulo: "📖 10. O QUE A BÍBLIA DIZ?",

    topicos: [

        {
            titulo: "📅 Segunda-feira — 1 Coríntios 1.10",
            texto:
                "Deus deseja que seus filhos vivam em união."
        },

        {
            titulo: "📅 Terça-feira — Eclesiastes 4.9",
            texto:
                "É melhor estar junto do que sozinho."
        },

        {
            titulo: "📅 Quarta-feira — Gálatas 6.2",
            texto:
                "Devemos ajudar uns aos outros."
        },

        {
            titulo: "📅 Quinta-feira — Eclesiastes 5.5",
            texto:
                "Devemos cumprir aquilo que prometemos."
        },

        {
            titulo: "📅 Sexta-feira — 1 João 4.20",
            texto:
                "Quem ama a Deus também deve amar seu irmão."
        },

        {
            titulo: "📅 Sábado — João 17.23",
            texto:
                "Jesus deseja que seus seguidores vivam unidos."
        }

    ]
},
            {
    titulo: "⭐ 11. VERSÍCULO PARA MEMORIZAR",

    texto:
        "Salmos 133.1\n\n“Como é bom e agradável que o povo de Deus viva unido como se todos fossem irmãos!”\n\nExplique às crianças que Deus se agrada quando seus filhos vivem em união.\n\nPergunte: Como podemos demonstrar união em nossa classe?\n\nRespostas: ajudando o colega, não praticando bullying, compartilhando, perdoando, não excluindo ninguém, respeitando o professor e ajudando quem está com dificuldade."
},

{
    titulo: "🧩 12. DINÂMICA — QUEBRA-CABEÇA DA UNIÃO",

    texto:
        "Prepare previamente uma cartolina, caneta e tesoura.\n\nEscreva o versículo de Salmos 133.1 em um coração desenhado na cartolina. Depois, recorte o coração em várias partes, formando um quebra-cabeça.\n\nDivida as crianças em pequenos grupos e entregue as peças para que montem o coração novamente.\n\nPergunte: Foi fácil montar o quebra-cabeça sozinho? Foi mais fácil quando todos ajudaram? O que acontece quando alguém não quer colaborar?\n\nExplique que, assim como cada peça é importante para formar o coração completo, cada pessoa também é importante para que a família, a igreja e a classe vivam em união.\n\nSe quiser realizar uma atividade em duplas ou trios, as crianças podem ficar com os braços levemente unidos por um cordão. ⚠️ Não aperte o cordão e nunca impeça os movimentos ou a circulação.\n\nConclua dizendo: Quando trabalhamos juntos, ajudamos uns aos outros e vivemos em união."
    },

    {
        titulo: "🪵 13. SALA DO PROFESSOR — O PALITO E A UNIÃO",

        texto:
            "Pegue um palito de madeira e mostre às crianças. Explique que um palito sozinho pode ser quebrado com facilidade.\n\nQuebre o palito e pergunte: Foi fácil quebrar?\n\nDepois, junte vários palitos e mostre que, juntos, eles ficam mais difíceis de quebrar.\n\nExplique: Assim como os palitos ficam mais fortes quando estão juntos, nós também precisamos uns dos outros. Na família, na escola e na igreja, devemos cuidar uns dos outros e trabalhar em união.\n\nPergunte: O que podemos fazer para ajudar nossa classe a ficar mais unida?\n\nConclua dizendo: Quando vivemos em união, ajudamos uns aos outros e mostramos o amor de Deus."
        },

    {
        titulo: "❤️ 14. ATIVIDADE — MEU COMPROMISSO DE UNIÃO",

        texto:
            "Entregue uma pequena folha de papel para cada criança.\n\nPeça que completem a frase:\n\n“Nesta semana eu vou demonstrar amor e união quando...”\n\nDê alguns exemplos: ajudar meu irmão, perdoar um amigo, evitar uma briga, compartilhar meus brinquedos ou ajudar alguém que esteja precisando.\n\nDepois, permita que cada criança leia seu compromisso para a turma, se desejar.\n\nExplique que o compromisso não deve ficar apenas no papel. Durante a semana, cada criança deverá procurar uma oportunidade para colocar em prática aquilo que escreveu.\n\n        Conclua dizendo: Viver em união também significa transformar nossas palavras em atitudes de amor."
    },

    {
      titulo: "💭 15. REFLEXÃO FINAL",

        texto:
            "Pergunte às crianças:\n\nVocê já brigou com alguém por uma coisa pequena?\n\nO que poderia ter feito diferente?\n\nExiste alguém que você precisa perdoar?\n\nExiste alguém que precisa da sua ajuda?\n\nExplique que a história de Jefté mostra que a divisão e as brigas podem trazer consequências muito sérias. Deus deseja que seus filhos escolham o amor, o perdão, a ajuda e a união.\n\n        Conclua dizendo: Antes de aumentar uma briga, podemos parar, conversar, perdoar e procurar fazer as pazes."
    },

    {
       titulo: "✝️ 16. APLICAÇÃO PRINCIPAL — EU POSSO SER UM PACIFICADOR! 🕊️",

        texto:
            "Escreva no quadro:\n\nEU POSSO SER UM PACIFICADOR! 🕊️\n\nExplique às crianças que um pacificador é alguém que procura resolver os problemas em vez de aumentar as brigas.\n\nEnsine esta sequência:\n\nPARAR → PENSAR → CONVERSAR → PERDOAR → FAZER AS PAZES.\n\nQuando alguém fizer algo que nos deixa chateados, não precisamos responder com outra briga. Podemos parar, pensar no que aconteceu, conversar com calma, perdoar e procurar fazer as pazes.\n\nLeia Mateus 5.9:\n\n“Bem-aventurados os pacificadores, porque eles serão chamados filhos de Deus.”\n\nPergunte: O que você pode fazer esta semana para ser um pacificador?\n\nConclua dizendo: Deus deseja que sejamos pessoas que promovem a paz, ajudam os outros e escolhem o amor em vez da briga."
    },
...
perguntas: [
    ...
    {
        nivel: "🟢 FÁCIL",
        pergunta: "Quem era o líder dos gileaditas?",
        resposta: "Jefté."
    },

    {
        nivel: "🟡 MÉDIA",
        pergunta: "Por que os efraimitas ficaram irritados com Jefté?",
        resposta: "Porque ficaram bravos por não terem sido chamados para participar da batalha contra os amonitas."
    },

    {
        nivel: "🟡 MÉDIA",
        pergunta: "O que os efraimitas fizeram quando ficaram irritados?",
        resposta: "Ameaçaram Jefté e provocaram os gileaditas, fazendo o conflito aumentar."
    },

    {
        nivel: "🔴 DIFÍCIL",
        pergunta: "Quais foram as principais causas do conflito entre os efraimitas e os gileaditas?",
        resposta: "O orgulho, a falta de companheirismo e a dificuldade de resolver o problema de maneira pacífica."
    },

    {
        nivel: "🔴 DESAFIO",
        pergunta: "O que podemos aprender com essa história para nossa vida?",
        resposta: "Devemos evitar o orgulho e as brigas, conversar para resolver os problemas, perdoar, ajudar uns aos outros e viver em união."
        }
    ...
    "pre-adolescentes": {
        ...
        "3": {
            ...
            "10": {
                ...
                titulo: "O Funcionamento da Igreja",

leituraBiblica:
    "1 Tessalonicenses 5.12,13; Romanos 12.8",

perguntaGancho:
                    "🎯Se a Igreja pertence a Cristo, quem deve cuidar para que tudo funcione corretamente: somente o pastor ou todos os membros têm uma responsabilidade?",

                curiosidade:
    "💡Você sabia que a Bíblia apresenta a Igreja como um corpo em que cada pessoa possui uma função? Deus não estabeleceu a Igreja para funcionar de qualquer maneira. Ele orienta sobre liderança, organização, serviço, responsabilidade e ordem, mostrando que cada membro tem um papel importante para que a Igreja cumpra sua missão.",
...
devocional: [
                    ...
                    {
                        dia: "✨ Segunda-feira — Respeitando as autoridades",

                        versiculo:
                            "📖 \"Toda pessoa esteja sujeita às autoridades superiores.\" — Romanos 13.1",

                        texto:
                            "Paulo ensina que Deus deseja que haja ordem na sociedade e orienta os cristãos a respeitarem as autoridades. Esse princípio também nos ajuda a compreender que a organização e o respeito são importantes para uma convivência saudável. A autoridade não deve ser usada para o mal, mas exercida com responsabilidade diante de Deus. Como cristãos, somos chamados a agir corretamente, respeitando as autoridades e cumprindo nossos deveres.",

                        pontos: [
                            "🙏 Respeite as autoridades e reconheça a importância da ordem.",
                            "🕊️ Cumpra seus deveres com responsabilidade diante de Deus.",
                            "✨ Seja um exemplo de boa conduta onde estiver."
                        ],

                        advertencia:
                            "⚠️ Advertência: Não use sua fé como justificativa para desrespeitar autoridades ou agir contra a ordem.",

                        aplicacao:
                            "💭 Aplicação pessoal: Procure hoje cumprir suas responsabilidades com respeito, honestidade e consciência de que suas atitudes também testemunham sua fé.",

                        fechamento:
                            "✨ Quem vive em ordem demonstra a beleza de uma vida guiada por Deus."
                    },

                    {
                        dia: "✨ Terça-feira — Pertencendo a Deus",

                        versiculo:
                            "📖 \"Dai, pois, a César o que é de César e a Deus o que é de Deus.\" — Mateus 22.21",

                        texto:
                            "Jesus foi questionado sobre o pagamento de impostos e respondeu mostrando que existem responsabilidades distintas. Ele ensinou que devemos cumprir nossos deveres terrenos sem esquecer que nossa vida pertence a Deus. Dar a César o que lhe pertence não diminui nossa devoção ao Senhor. Pelo contrário, demonstra responsabilidade e equilíbrio na maneira como vivemos neste mundo.",

                        pontos: [
                            "🙏 Cumpra corretamente suas responsabilidades.",
                            "🕊️ Reconheça que sua vida pertence a Deus.",
                            "✨ Mantenha equilíbrio entre seus deveres e sua fé."
                        ],

                        advertencia:
                            "⚠️ Advertência: Não permita que as responsabilidades deste mundo ocupem o lugar que pertence a Deus.",

                        aplicacao:
                            "💭 Aplicação pessoal: Faça suas obrigações com honestidade, mas reserve também tempo e dedicação para aquilo que pertence ao Senhor.",

                        fechamento:
                            "✨ Cumprir seus deveres é importante, mas viver para Deus é essencial."
                    },

                    {
                        dia: "✨ Quarta-feira — Calculando o custo",

                        versiculo:
                            "📖 \"Qual de vós, querendo edificar uma torre, não se assenta primeiro a fazer as contas dos gastos?\" — Lucas 14.28",

                        texto:
                            "Jesus ensinou sobre a importância de avaliar cuidadosamente o compromisso antes de iniciá-lo. A construção de uma torre exige planejamento, recursos e disposição para concluir o trabalho. Da mesma forma, seguir a Cristo não deve ser uma decisão superficial ou baseada apenas em emoção momentânea. O discípulo precisa compreender que existe compromisso e perseverança no caminho da fé.",

                        pontos: [
                            "🙏 Pense antes de assumir um compromisso.",
                            "🕊️ Esteja disposto a perseverar até o fim.",
                            "✨ Não trate sua caminhada com Cristo de maneira superficial."
                        ],

                        advertencia:
                            "⚠️ Advertência: Não comece algo importante sem considerar seriamente a responsabilidade envolvida.",

                        aplicacao:
                            "💭 Aplicação pessoal: Avalie seus compromissos espirituais e procure cumprir com fidelidade aquilo que você assumiu diante de Deus.",

                        fechamento:
                            "✨ Quem começa com compromisso encontra forças para continuar."
                    },

                    {
                        dia: "✨ Quinta-feira — Cooperadores de Deus",

                        versiculo:
                            "📖 \"Porque nós somos cooperadores de Deus; vós sois lavoura de Deus e edifício de Deus.\" — 1 Coríntios 3.9",

                        texto:
                            "Paulo mostra que o trabalho realizado na obra de Deus envolve cooperação. Ele utiliza imagens de uma lavoura e de um edifício para mostrar que a Igreja pertence ao Senhor e que seus servos participam do trabalho que Ele realiza. Ninguém deve agir como dono da obra, pois Deus é quem está no centro. Servir ao Senhor significa trabalhar em união e com humildade.",

                        pontos: [
                            "🙏 Trabalhe na obra de Deus com disposição.",
                            "🕊️ Valorize a cooperação entre os irmãos.",
                            "✨ Sirva sabendo que a obra pertence ao Senhor."
                        ],

                        advertencia:
                            "⚠️ Advertência: Não transforme o serviço cristão em motivo de competição ou orgulho pessoal.",

                        aplicacao:
                            "💭 Aplicação pessoal: Procure descobrir como pode contribuir para a Igreja e sirva com humildade, cooperando com seus irmãos.",

                        fechamento:
                            "✨ Na obra de Deus, servir juntos é melhor do que competir."
                    },

                    {
                        dia: "✨ Sexta-feira — Deus é Deus de ordem",

                        versiculo:
                            "📖 \"Porque Deus não é Deus de confusão, senão de paz.\" — 1 Coríntios 14.33",

                        texto:
                            "Ao orientar a igreja de Corinto, Paulo ensinou que os momentos de culto deveriam refletir o caráter de Deus. Havia muitos dons e manifestações, mas tudo precisava acontecer de maneira que trouxesse edificação e paz. A presença de dons não elimina a necessidade de organização e responsabilidade. A Igreja deve buscar uma maneira de servir que edifique todos e glorifique ao Senhor.",

                        pontos: [
                            "🙏 Busque a paz na convivência cristã.",
                            "🕊️ Valorize aquilo que promove edificação.",
                            "✨ Permita que suas atitudes contribuam para a ordem da Igreja."
                        ],

                        advertencia:
                            "⚠️ Advertência: Não confunda liberdade cristã com desorganização ou atitudes que prejudiquem a edificação dos outros.",

                        aplicacao:
                            "💭 Aplicação pessoal: Antes de agir, pense se sua atitude contribuirá para a paz, a organização e o crescimento dos irmãos.",

                        fechamento:
                            "✨ Onde Deus é honrado, a confusão não precisa dominar."
                    },

                    {
                        dia: "✨ Sábado — Tudo com decência e ordem",

                        versiculo:
                            "📖 \"Mas faça-se tudo decentemente e com ordem.\" — 1 Coríntios 14.40",

                        texto:
                            "Paulo encerra suas orientações à igreja de Corinto destacando a importância da ordem. O culto cristão não deveria ser marcado pela confusão, mas por atitudes que demonstrassem respeito e contribuíssem para a edificação da Igreja. Esse princípio mostra que organização também faz parte do serviço cristão. Fazer tudo com decência e ordem significa agir de maneira responsável, respeitosa e coerente com a fé que professamos.",

                        pontos: [
                            "🙏 Valorize a organização na Igreja.",
                            "🕊️ Aja com respeito durante o serviço cristão.",
                            "✨ Busque sempre aquilo que edifica os irmãos."
                        ],

                        advertencia:
                            "⚠️ Advertência: Não permita que atitudes desorganizadas ou egoístas atrapalhem o trabalho e a comunhão da Igreja.",

                        aplicacao:
                            "💭 Aplicação pessoal: Em qualquer função que você exerça, procure realizar suas tarefas com responsabilidade, respeito e organização.",

                        fechamento:
                            "✨ A ordem transforma o serviço em um testemunho de dedicação a Deus."
                    }
                ...
                licaoHoje: {
                    ...
                    pontoPrincipal:
                        "• Ponto principal: A Igreja deve reconhecer, respeitar e valorizar aqueles que trabalham e exercem responsabilidades em seu meio, enquanto cada cristão deve servir com dedicação e responsabilidade."
                },

                bibliaDiz: {

                    versiculo:
                        "\"Pois, se alguém não sabe governar a sua própria família, como poderá cuidar da Igreja de Deus?\" 1 Timóteo 3.5",

                    pontoPrincipal:
                        "• Ponto principal: A capacidade de cuidar bem da própria família é apresentada por Paulo como uma questão importante para aqueles que exercem responsabilidade na Igreja."
                },

                objetivos: [
                    "⚖️ CONSCIENTIZAR que a igreja deve respeitar as leis;",
                    "💰 ENSINAR que a igreja tem responsabilidades em pagar contas;",
                    "🏛️ MOSTRAR a igreja como uma organização."
                ],

                introducao:
    "A Igreja de Cristo não existe apenas para realizar cultos, mas também precisa funcionar de maneira organizada e responsável. Assim como uma família ou uma instituição possui responsabilidades, a Igreja também deve cumprir seus deveres diante de Deus e da sociedade. Nesta lição, aprenderemos que a Igreja deve respeitar as leis, cumprir suas responsabilidades e manter uma organização que contribua para o bom funcionamento de suas atividades.",
...
conhecendoMaisDeDeus: {
                    ...
                    texto:
                        "Olá, caro(a) aluno(a)! Você sabe explicar para que servem as leis? No Antigo Testamento, enquanto os israelitas peregrinavam no deserto rumo à Terra Prometida, houve a necessidade de criar regras que orientassem como eles deveriam se comportar, haja vista que os hebreus viviam de acordo como aprenderam no período em que estiveram no Egito (cf. Êx 32.1-8).",

                    pontoPrincipal:
                        "📌 Ponto principal As leis foram necessárias para orientar o comportamento do povo e estabelecer regras para sua convivência."
                },
                ...
                desenvolvimento: [
                    ...
                    {
                        titulo:
                            "⚖️ 1. A IGREJA RESPEITA AS LEIS",

                        texto:
                            "Respeitar as leis faz parte da vida em sociedade. As leis existem para que as pessoas não façam tudo conforme o que pensam ou querem fazer. A Igreja está inserida na sociedade e, portanto, deve obedecer às leis do país, desde que estas não contrariem a Palavra de Deus.",

                        pontoPrincipal:
                            "📌 Ponto principal A Igreja deve respeitar as leis do país, desde que não contrariem a Palavra de Deus.",
                        ...
                        topicos: [

                            {
                                ...
                                texto:
                                    "O Senhor chamou Moisés no Monte Sinai e entregou a Lei ao seu povo, também conhecida como Dez Mandamentos. A finalidade dos Mandamentos era conduzir o povo de modo santo e espiritual. Neles estão contidas as orientações a respeito de assuntos morais, civis e cerimoniais que faziam parte do dia a dia de Israel. No Novo Testamento, o Mestre disse que não veio para desfazer a lei ou as palavras dos profetas, antes, veio cumpri-las e confirmá-las. Assim o Mestre fez, deixando o exemplo para todos que viessem após Ele (cf. Mt 5.17).",

                                pontoPrincipal:
                                    "📌 Ponto principal A Lei foi dada para orientar o povo de Deus em uma vida santa e obediente.",
                                ...
                                versiculos: [

                                    {
                                        ...
                                        pontoPrincipal:
                                            "Deus foi quem estabeleceu os mandamentos para o seu povo."
                                    },

                                    {
                                        ...
                                        pontoPrincipal:
                                            "Jesus declarou que veio cumprir a Lei e os Profetas."
                                    }

                                ],

                                exortacao:
                                    "⚠️ Exortação prática Devemos conhecer os ensinamentos das Escrituras e permitir que a Palavra de Deus oriente nossa maneira de viver.",

                                reflexao:
                                    "💭 Reflexão para a vida cristã A Palavra de Deus não deve ser apenas conhecida, mas praticada. Ela nos orienta sobre como viver de maneira que agrade ao Senhor.",

                                palavrasChave: [
                                    "📜 Lei — Orientação estabelecida por Deus para o seu povo.",
                                    "🧭 Orientação — Direção que ajuda alguém a saber como deve agir.",
                                    "✨ Santidade — Vida separada para Deus e dedicada à sua vontade."
                                ]
                            },

                            {
                                ...
                                texto:
                                    "Quando veio a este mundo, Ele fez questão de andar conforme as leis de sua época e obedeceu rigorosamente ao Império Romano dando o tributo a César e aos reis na ocasião. O apóstolo Paulo confirmou os mesmos princípios e falou sobre a necessidade de obedecermos às leis e às autoridades (Rm 13.1-7).",

                                pontoPrincipal:
                                    "📌 Ponto principal Jesus deixou exemplo de respeito às responsabilidades civis e às autoridades.",

                                versiculos: [

                                    {
                                        referencia: "Mateus 22.21",
                                        texto:
                                            "“Dizem-lhe eles: De César. Então, ele lhes disse: Dai, pois, a César o que é de César e a Deus, o que é de Deus.”",
                                        pontoPrincipal:
                                            "Jesus ensinou sobre o cumprimento das responsabilidades civis e espirituais."
                                    },

                                    {
                                        referencia: "Romanos 13.1",
                                        texto:
                                            "“Toda alma esteja sujeita às potestades superiores; porque não há potestade que não venha de Deus; e as potestades que há foram ordenadas por Deus.”",
                                        pontoPrincipal:
                                            "Paulo ensinou os cristãos a respeitarem as autoridades."
                                    }

                                ],

                                exortacao:
                                    "⚠️ Exortação prática Siga o exemplo de Jesus, cumprindo suas responsabilidades e tratando as autoridades com respeito.",

                                reflexao:
                                    "💭 Reflexão para a vida cristã Ser cristão não significa ignorar nossas responsabilidades como cidadãos. Nossa fé deve produzir uma vida responsável e coerente.",

                                palavrasChave: [
                                    "✝️ Exemplo — Modelo que pode ser seguido.",
                                    "🏛️ Autoridade — Poder ou responsabilidade reconhecida para governar.",
                                    "💰 Tributo — Valor devido ao governo ou à autoridade estabelecida."
                                ]
                            }
                    ...
                    {
                        titulo:
                            "💰 2. A IGREJA PAGA CONTAS",

                        texto:
                            "Sabemos que a Lei de Deus é suprema e devemos obedecê-la. Entretanto, enquanto estivermos aqui nesta terra, as leis e autoridades terrenas devem ser obedecidas. Vale lembrar as palavras de Jesus: \"Deem ao Imperador o que é do Imperador e deem a Deus o que é de Deus\" (Mt 22.21).",

                        pontoPrincipal:
                            "📌 Ponto principal A Igreja deve cumprir suas responsabilidades diante das autoridades e da sociedade.",

                        topicos: [

                            {
                                titulo:
                                    "🏛️ a) A Igreja é o exemplo",

                                texto:
                                    "A Igreja é uma instituição que deve cumprir com alguns regulamentos previstos nas leis do Estado ou cidade na qual está construída (instalada). Da mesma forma que na casa onde moramos devemos pagar as despesas como energia elétrica, conta de água, etc, a igreja também precisa, enquanto prédio, saldar todos os seus compromissos. Por isso, Paulo confirmou os ensinos de Jesus: \"Portanto, paguem ao governo o que é devido. Paguem todos os seus impostos e respeitem e honrem todas as autoridades” (Rm 13.7).",

                                pontoPrincipal:
                                    "📌 Ponto principal A Igreja deve cumprir seus compromissos financeiros e legais com responsabilidade.",

                                versiculos: [

                                    {
                                        referencia: "Romanos 13.7",
                                        texto:
                                            "“Dai a cada um o que deveis: a quem tributo, tributo; a quem imposto, imposto; a quem temor, temor; a quem honra, honra.”",
                                        pontoPrincipal:
                                            "Devemos cumprir aquilo que é devido e respeitar as autoridades."
                                    },

                                    {
                                        ...
                                        pontoPrincipal:
                                            "O cristão deve procurar viver corretamente em seus compromissos."
                                    }

                                ],

                                exortacao:
                                    "⚠️ Exortação prática A Igreja deve cuidar de suas despesas e compromissos com responsabilidade, evitando negligência na administração dos recursos.",

                                reflexao:
                                    "💭 Reflexão para a vida cristã Uma Igreja organizada também demonstra responsabilidade diante da comunidade. A maneira como seus recursos são administrados pode contribuir para um bom testemunho cristão.",

                                palavrasChave: [
                                    "🧾 Compromisso — Responsabilidade assumida que deve ser cumprida.",
                                    "🏛️ Instituição — Organização estabelecida para cumprir determinada finalidade.",
                                    "💳 Despesa — Valor necessário para manter determinada atividade ou estrutura."
                                ]
                            },

                            {
                                titulo:
                                    "🕊️ b) Igreja, lugar de ordem",

                                texto:
                                    "A Casa de Deus é um lugar de ordem e decência como as Escrituras dizem (cf. Rm 13.6). \"Portanto, façam tudo com decência e ordem\" (1 Co 14.40).",

                                pontoPrincipal:
                                    "📌 Ponto principal A Igreja deve funcionar com decência, organização e ordem.",
                                ...
                                versiculos: [

                                    {
                                        ...
                                        pontoPrincipal:
                                            "Tudo na Igreja deve ser realizado de maneira organizada e apropriada."
                                    },

                                    {
                                        ...
                                        pontoPrincipal:
                                            "A ordem e a paz devem marcar a vida da Igreja."
                                    }

                                ],

                                exortacao:
                                    "⚠️ Exortação prática Procure contribuir para que a Igreja seja um ambiente organizado, respeitoso e edificante, evitando atitudes que produzam confusão.",

                                reflexao:
                                    "💭 Reflexão para a vida cristã A ordem não é apenas uma questão de organização externa. Ela também revela responsabilidade, respeito pelos irmãos e cuidado com aquilo que pertence ao serviço de Deus.",

                                palavrasChave: [
                                    "🕊️ Ordem — Organização adequada das coisas.",
                                    "✨ Decência — Maneira correta, respeitosa e apropriada de agir.",
                                    "🤝 Edificação — Ação que contribui para o crescimento e fortalecimento dos irmãos."
                                ]
                            }
                    ...
                    {
                        titulo:
                            "🏛️ 3. A IGREJA É UMA ORGANIZAÇÃO",

                        texto:
                            "Você sabe o que é uma organização? Trata-se de um grupo de pessoas ou instituição que realiza ações com uma única finalidade. A Igreja, ao mesmo tempo em que é uma organização social, é também um organismo espiritual, isto é, o Corpo de Cristo reunido para adorar a Deus e anunciar a sua mensagem de salvação.",

                        pontoPrincipal:
                            "📌 Ponto principal A Igreja é uma organização social e, principalmente, um organismo espiritual que adora a Deus e anuncia a salvação.",

                        topicos: [

                            {
                                titulo:
                                    "🏛️ a) Organização institucional",

                                texto:
                                    "Já na Igreja Primitiva, os irmãos congregavam de casa em casa e oravam juntos no cenáculo do Templo em um mesmo propósito (At 14.23). Nos dias atuais, a Igreja é uma organização institucional, constituída de espaços próprios ou alugados para a realização dos cultos em adoração a Deus. As igrejas possuem patrimônios, membros, regras de regimento interno, estatuto próprio, etc. Tudo isso visando manter a boa ordem e funcionamento da instituição.",

                                pontoPrincipal:
                                    "📌 Ponto principal A organização institucional contribui para a boa ordem e o funcionamento da Igreja.",
                                ...
                                versiculos: [

                                    {
                                        ...
                                        pontoPrincipal:
                                            "A Igreja Primitiva possuía liderança e organização para cuidar das congregações."
                                    },

                                    {
                                        ...
                                        texto:
                                            "“Mas faça-se tudo decentemente e com ordem.”",
                                        pontoPrincipal:
                                            "A organização deve contribuir para que tudo seja realizado com ordem."
                                    }

                                ],

                                exortacao:
                                    "⚠️ Exortação prática Valorize a organização da Igreja e contribua para que suas atividades, espaços e responsabilidades sejam conduzidos com ordem e responsabilidade.",

                                reflexao:
                                    "💭 Reflexão para a vida cristã Uma boa organização não substitui a vida espiritual, mas pode ajudar a Igreja a cumprir suas atividades e servir melhor aos seus membros e à comunidade.",

                                palavrasChave: [
                                    "🏛️ Instituição — Organização estabelecida para cumprir uma finalidade.",
                                    "📋 Regimento — Conjunto de regras que orientam o funcionamento de uma instituição.",
                                    "🤝 Comunidade — Grupo de pessoas reunidas e relacionadas por um propósito."
                                ]
                            },

                            {
                                titulo:
                                    "📍 b) Aspectos da organização",

                                texto:
                                    "A igreja precisa ter um endereço fixo e um nome bem visível para identificá-la. Essa organização é humana, precisa cumprir as suas obrigações legais, é imperfeita e temporal, ou seja, ela passará. Porém, a Igreja espiritual não está restrita a tempo ou espaço físico. É essa Igreja espiritual que o Senhor Jesus voltará para buscar.",

                                pontoPrincipal:
                                    "📌 Ponto principal A organização física é temporal, mas a Igreja espiritual pertence a Cristo e não está limitada a um espaço físico.",
                                ...
                                versiculos: [

                                    {
                                        ...
                                        pontoPrincipal:
                                            "Jesus prometeu voltar para receber os seus."
                                    },

                                    {
                                        referencia: "1 Coríntios 3.9",
                                        texto:
                                            "“Porque nós somos cooperadores de Deus; vós sois lavoura de Deus e edifício de Deus.”",
                                        pontoPrincipal:
                                            "Os cristãos pertencem à obra de Deus e fazem parte de seu povo."
                                    }

                                ],

                                exortacao:
                                    "⚠️ Exortação prática Não coloque sua confiança apenas em estruturas, prédios ou organizações humanas. Valorize a instituição, mas mantenha seu foco em Cristo e na vida espiritual.",

                                reflexao:
                                    "💭 Reflexão para a vida cristã Um templo pode ser construído, reformado ou até deixar de existir, mas a Igreja de Cristo não depende de um prédio. Nossa esperança está no Senhor Jesus e na sua promessa.",

                                palavrasChave: [
                                    "📍 Endereço — Local onde uma instituição está estabelecida.",
                                    "🏛️ Estrutura — Organização física e administrativa de uma instituição.",
                                    "✝️ Igreja espiritual — O povo de Deus que pertence a Cristo."
                                ]
                            }
                ...
                conclusao:
                    "📝 CONCLUSÃO\nDeus espera que a sua Igreja cumpra as leis neste mundo e seja o exemplo para a sociedade. Que possamos como um só Corpo obedecer à Palavra de Deus, nossa Lei maior.",
                ...
                perguntas: [

                    {
                        nivel: "🟢 1. Fácil",
                        pergunta:
                            "O que a Igreja deve fazer em relação às leis do país?",
                        resposta:
                            "A Igreja deve respeitar e obedecer às leis do país, desde que elas não contrariem a Palavra de Deus."
                    },

                    {
                        nivel: "🟡 2. Média",
                        pergunta:
                            "Por que a Igreja precisa cumprir suas responsabilidades financeiras?",
                        resposta:
                            "Porque a Igreja é uma organização inserida na sociedade e deve cumprir seus compromissos, como despesas, impostos e outras obrigações legais."
                    },

                    {
                        nivel: "🟠 3. Difícil",
                        pergunta:
                            "Qual é a diferença entre a Igreja como organização social e a Igreja como organismo espiritual?",
                        resposta:
                            "Como organização social, a Igreja possui estrutura, patrimônio, membros, regras e obrigações legais. Como organismo espiritual, ela é o Corpo de Cristo, reunido para adorar a Deus e anunciar a mensagem de salvação."
                    },

                    {
                        nivel: "🔴 4. Difícil",
                        pergunta:
                            "O que Jesus ensinou ao dizer: “Dai, pois, a César o que é de César e a Deus, o que é de Deus”?",
                        resposta:
                            "Jesus ensinou que devemos cumprir nossas responsabilidades civis, sem deixar de reconhecer que nossa vida e nossa fidelidade pertencem a Deus."
                    },

                    {
                        nivel: "🔴 5. Difícil",
                        pergunta:
                            "Por que a organização da Igreja não deve ser confundida com a própria Igreja espiritual?",
                        resposta:
                            "Porque a organização física e institucional é temporal e possui estruturas humanas, enquanto a Igreja espiritual pertence a Cristo e não está limitada a um prédio, endereço ou estrutura humana."
                    }
...
,
    ...
    mensagem: "“O SENHOR Deus me deu o seu Espírito, pois Ele me escolheu para levar boas notícias aos pobres. Ele me enviou para animar os aflitos, para anunciar a libertação aos escravos e a liberdade para os que estão na prisão.” — Isaías 61.1",
    ...
    devocional: [
        {
            ...
            advertencia: "⚠️ Advertência: Não devemos guardar para nós a mensagem que recebemos, esquecendo que fomos chamados para testemunhar.",
            aplicacao: "💭 Aplicação pessoal: Procure hoje uma oportunidade para falar de Jesus com alguém, demonstrando sua fé também por meio de suas atitudes.",
            final: "✨ Quem conhece a mensagem de Cristo pode ajudar a levá-la mais longe."
        },
        {
            dia: "TERÇA-FEIRA",
            titulo: "ENVIADOS POR JESUS",
            ...
            advertencia: "⚠️ Advertência: Não devemos pensar que testemunhar sobre Cristo é responsabilidade apenas de líderes ou missionários que viajam para outros lugares.",
            aplicacao: "💭 Aplicação pessoal: Seja um testemunho de Cristo em sua casa, escola, trabalho e comunidade, tratando as pessoas com amor e verdade.",
            final: "✨ Onde Deus nos coloca, também pode nos usar para testemunhar."
        },
        {
            dia: "QUARTA-FEIRA",
            titulo: "A SEARA É GRANDE",
            ...
            advertencia: "⚠️ Advertência: Não devemos perceber as necessidades espirituais das pessoas e permanecer indiferentes diante delas.",
            aplicacao: "💭 Aplicação pessoal: Ore por pessoas que ainda não conhecem a Cristo e pergunte a Deus como você pode participar da obra missionária.",
            final: "✨ Quem ora pela missão também pode ser chamado a participar dela."
        },
        {
            dia: "QUINTA-FEIRA",
            titulo: "ANUNCIANDO ÀS NAÇÕES",
            ...
            advertencia: "⚠️ Advertência: Não devemos tratar a missão como algo sem importância, pois anunciar a glória de Deus faz parte do nosso testemunho.",
            aplicacao: "💭 Aplicação pessoal: Compartilhe com alguém uma palavra bíblica, um testemunho ou uma verdade que demonstre aquilo que Deus tem feito.",
            final: "✨ Quando anunciamos a glória de Deus, apontamos pessoas para Ele."
        },
        {
            dia: "SEXTA-FEIRA",
            titulo: "CHAMADOS PARA ESTAR COM ELE",
            ...
            advertencia: "⚠️ Advertência: Atividade na obra de Deus não deve substituir nossa comunhão pessoal com Jesus.",
            aplicacao: "💭 Aplicação pessoal: Separe tempo para orar, ler a Bíblia e fortalecer sua comunhão com Cristo, permitindo que essa relação influencie seu testemunho.",
            final: "✨ Quem caminha com Jesus encontra direção para servir."
        },
        {
            dia: "SÁBADO",
            titulo: "EIS-ME AQUI",
            ...
            advertencia: "⚠️ Advertência: Não devemos deixar que o medo ou a acomodação nos impeçam de responder quando Deus nos chama para servir.",
            aplicacao: "💭 Aplicação pessoal: Ore e coloque seus dons, seu tempo e sua disposição à disposição de Deus para participar da missão.",
            final: "✨ Uma vida disponível pode ser instrumento nas mãos de Deus."
        }
    ],

    bibliaDiz: {
        texto: "“O SENHOR Deus me deu o seu Espírito, pois Ele me escolheu para levar boas notícias aos pobres. Ele me enviou para animar os aflitos, para anunciar a libertação aos escravos e a liberdade para os que estão na prisão.”",
    ...
    perguntas: [
        {
            pergunta: "🟢 Fácil: Qual é a principal tarefa da obra missionária?",
            resposta: "Anunciar o Evangelho e levar a mensagem de salvação às pessoas."
        },
        {
            pergunta: "🟡 Média: Quais são algumas formas de participar de Missões?",
        ...
        {
            pergunta: "🔴 Difícil: Por que a pouca idade não é impedimento para servir a Deus?",
        ...
        {
            pergunta: "🔴 Difícil: O que Jesus fazia além de anunciar o Evangelho?",
        ...
        {
            pergunta: "🔴 Difícil: Como um pré-adolescente pode participar da obra missionária mesmo sem ir para um lugar distante?",
